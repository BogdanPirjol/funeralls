...
app.post("/anaf", async (req, res) => {
  ...
  try {
    ...
    const newData = new Uint8Array(chunks[0]);
...
app.post("/generate-pdf", async (req, res) => {
  ...
  <body>
    <div class="font-serif max-w-[900px] m-auto">
      <div class="flex flex-col items-center p-10">
        
        <div class="flex flex-col items-center gap-y-3">
          <span class="uppercase text-2xl font-semibold">
            contract de intermediere
          </span>
          <span class="uppercase text-xl font-semibold text-center">
        ...
        <div class="flex gap-x-8">
          ...
          <div>
            <span>
              ...
              <p class="text-blue-700 inline underline">
                www.funeralls.com
              </p>
        ...
        <div class="flex gap-x-8">
          ...
          <div>
            <span>
              ...
              informatice)
              <p class="inline text-blue-700 underline">
                www.funeralls.com
              </p>
      ...
      <div class="flex flex-col gap-y-4 mt-10">
        ...
        <div class="flex justify-center">
          <span class="font-semibold italic">Art.7 Comisionul</span>
        </div>
        <div class="flex gap-x-8">
          <div>
            <span>(1)</span>
        ...
        <div class="flex gap-x-8">
          ...
          <div class="max-w-full">
            ...
            <div class="flex gap-x-2 items-start max-w-full">
              <div>
                <svg width="20" height="20" xmlns="http://www.w3.org/2000/svg">
                  <rect
                    x="5"
      ...
      <div class="flex flex-col gap-y-4 mt-10">
        ...
        <div class="flex justify-center">
          <span class="font-semibold italic">Art.13 Sancțiuni</span>
        </div>
        <div class="flex gap-x-8">
          <div>
            <span>(1)</span>
